...
/**
 * Created by ryo on 2017/09/18.
 *
 * ジャイロセンサーを使う
 */
class GyrosensorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        accel = sensorMgr.getDefaultSensor(Sensor.TYPE_GYROSCOPE)
    }
    ...
    private class SensorSimulator(
        ...
        override fun onSensorChanged(p0: SensorEvent?) {
            ...
            if(p0?.sensor?.type != Sensor.TYPE_GYROSCOPE) return
